    ...
    it('should not verify an invalid signature', () => {
      expect(
        verifySignature({
          publicKey: wallet.publicKey,
          payload,
          signature: new Wallet().sign(payload),
        })
      ).toBe(false);
    });
  });
  ...
  describe('Calculate the balance', () => {
    ...
    describe('and there are outputs/transactions for the wallet', () => {
      ...
      beforeEach(() => {
        ...
        blockchain.createNewBlock({ payload: [transaction_1, transaction_2] });
      });
      ...
      describe('and the wallet has made a transaction', () => {
        ...
        beforeEach(() => {
          ...
          blockchain.createNewBlock({ payload: [latestTransaction] });
        });
        ...
        describe('and there are outputs next and after the recent transaction', () => {
          ...
          beforeEach(() => {
            ...
            blockchain.createNewBlock({
              payload: [latestTransaction, currentBlockTransaction],
            });
            ...
            blockchain.createNewBlock({ payload: [nextBlockTransaction] });
          });
